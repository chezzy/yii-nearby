...
<head>
	...
	<?php Yii::app()->clientScript
		...
		->registerCssFile('http:///netdna.bootstrapcdn.com/bootstrap/3.0.3/css/bootstrap.min.css')
		->registerScriptFile('https://code.jquery.com/jquery.js')
		->registerScriptFile('http://netdna.bootstrapcdn.com/bootstrap/3.0.3/js/bootstrap.min.js')
